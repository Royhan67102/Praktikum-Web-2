...
<head>
    ...
    <style>
        body {
            background-image: url('1.gif'); /* Ganti 'animated_background.gif' dengan URL gambar GIF animasi kartun Anda */
            color: white;
        }
        ...
        table {
            background-color: rgba(255, 255, 255, 0.8); /* Menggunakan latar belakang semi-transparan agar teks lebih mudah terbaca */
            border-radius: 10px;
            overflow: hidden;
        }
